...
const en = {
  ...
  'action.share': 'Share',
  'action.skip': 'Skip',
  'action.startPlaying': "Let's play",
  ...
  'aria.stageHud': 'Live game status',
  ...
  'confirm.resetMatch': 'Reset the active match?',
  ...
  'tutorial.board.body': 'The board is a 3 × 3 × 3 cube. Spread it into three floors—or collapse it again—without changing any cell.',
  'tutorial.board.title': 'One cube, three floors',
  'tutorial.crossFloor.body': 'Cells 1, 14, and 27 make one diagonal through all three floors. Lines can travel across the whole cube.',
  'tutorial.crossFloor.title': 'Lines cross floors',
  'tutorial.lines.body': 'Every completed 3-in-a-row scores 1 line. Play continues until all 27 cells fill; the higher total wins.',
  'tutorial.lines.title': 'Score every line',
  'tutorial.progress': 'Step {current} of {total}',
  'tutorial.scoreBadge': '+1 line',
  'tutorial.tapAgain': 'Tap again to place',
  'tutorial.touch.body': 'In Cube and Floors on touch, tap a cell once to arm it. Tap the same cell again to place your mark.',
  'tutorial.touch.title': 'Tap, then confirm',
  'tutorial.views.body': 'Cube teaches depth, Floors reveals every plane, and Scanner is the quick-play view. Coach marks scores in green and blocks in red.',
  'tutorial.views.title': 'Choose your view',
  ...
  'hud.lines': 'Lines',
  'hud.match': 'Match',
  'hud.opponentTurn': "Opponent's turn · {player}",
  'hud.remaining': 'Cells left',
  'hud.result': 'Result',
  'hud.turn': 'Turn',
  'hud.yourTurn': 'Your turn · {player}',
  ...
  'match.opener': 'Opener',
  'match.playerScore': 'X {x} · O {o}',
  'match.round': 'Round',
  'match.soloScore': 'You {you} · AI {ai}',
  'match.winner': 'Winner',
  'menu.configure': 'Choose your mode and rules below. You can return here without losing the round.',
  'menu.howToPlay': 'How to play',
  'menu.label': 'Game menu',
  'menu.open': 'Open game menu',
  'menu.play': 'Play',
  'menu.resume': 'Resume',
  'menu.tagline': 'Fast, readable 3D strategy across all three floors.',
  ...
  'online.confirmationTimeout': 'Room confirmation timed out. Reconnect before playing.',
  ...
  'online.status.peer-waiting': 'peer away',
  'online.status.reconnecting': 'reconnecting',
  'online.status.waiting': 'waiting',
  'online.peerWaiting': 'Room paused - waiting for the other player to return.',
  ...
  'options.feedbackHint': 'Report bugs & share ideas',
  'options.sound': 'Sound',
  'options.style': 'Style',
  ...
  'puzzle.cellLabel': 'Cell {cell}, floor {floor}, row {row}, column {column}, {value}',
  ...
  'setup.changingStarts': 'Changing these starts a new match',
  'setup.difficulty': 'AI',
  'setup.endgame': 'Endgame',
  'setup.mode': 'Mode',
  'setup.rules': 'Rules',
  'setup.switchEndgameConfirm': 'Switching the Lines endgame resets the active best of 5.',
  'setup.switchDifficultyConfirm': 'Changing AI difficulty resets the active best of 5.',
  'setup.switchModeConfirm': 'Switching to {mode} resets the active best of 5.',
  'setup.switchRulesConfirm': 'Switching to {ruleset} resets the active best of 5.',
  'setup.switchSideConfirm': 'Switching sides resets the active best of 5.',
  'setup.title': 'Setup',
  'setup.youPlay': 'You play',
  'scanner.caption': 'Floor {floor} of 3',
  'scanner.firstUseHint': 'Floor {floor} of 3 — lines can cross floors.',
  'sound.off': 'Off',
  'sound.on': 'On',
  ...
  'status.confirmingOnlineAction': 'Confirming with the room…',
  ...
  'status.opponentReconnect': 'Waiting for opponent',
...
const tr = {
  ...
  'aria.stageHud': 'Canlı oyun durumu',
  ...
  'confirm.resetMatch': 'Aktif maç sıfırlansın mı?',
  ...
  'tutorial.board.body': 'Tahta 3 × 3 × 3 bir küptür. Hiçbir hücreyi değiştirmeden üç kata açabilir veya tekrar küp hâline getirebilirsin.',
  'tutorial.board.title': 'Tek küp, üç kat',
  'tutorial.crossFloor.body': '1, 14 ve 27 hücreleri üç katın içinden geçen tek bir çapraz oluşturur. Çizgiler tüm küpü aşabilir.',
  'tutorial.crossFloor.title': 'Çizgiler katları aşar',
  'tutorial.lines.body': 'Tamamlanan her üçlü 1 çizgi kazandırır. 27 hücrenin tamamı dolana kadar oyun sürer; yüksek toplam kazanır.',
  'tutorial.lines.title': 'Her çizgiden skor kazan',
  'tutorial.progress': 'Adım {current} / {total}',
  'tutorial.scoreBadge': '+1 çizgi',
  'tutorial.tapAgain': 'Yerleştirmek için tekrar dokun',
  'tutorial.touch.body': 'Dokunmatik ekranda Küp ve Katlar görünümünde bir hücreye ilk dokunuş seçimi hazırlar. İşaretini koymak için aynı hücreye tekrar dokun.',
  'tutorial.touch.title': 'Dokun, sonra onayla',
  'tutorial.views.body': 'Küp derinliği öğretir, Katlar tüm düzlemleri gösterir, Tarayıcı ise hızlı oyun görünümüdür. Koç skorları yeşil, blokları kırmızı işaretler.',
  'tutorial.views.title': 'Görünümünü seç',
  ...
  'hud.lines': 'Çizgiler',
  'hud.match': 'Maç',
  'hud.opponentTurn': 'Rakibinin sırası · {player}',
  'hud.remaining': 'Kalan',
  'hud.result': 'Sonuç',
  'hud.turn': 'Sıra',
  'hud.yourTurn': 'Sıra sende · {player}',
  ...
  'match.playerScore': 'X {x} · O {o}',
  'match.round': 'Tur',
  'match.soloScore': 'Sen {you} · AI {ai}',
  'match.winner': 'Kazanan',
  'menu.configure': 'Modunu ve kurallarını aşağıdan seç. Turu kaybetmeden bu menüye dönebilirsin.',
  'menu.howToPlay': 'Nasıl oynanır',
  'menu.label': 'Oyun menüsü',
  'menu.open': 'Oyun menüsünü aç',
  'menu.play': 'Oyna',
  'menu.resume': 'Devam et',
  'menu.tagline': 'Üç katın tamamında hızlı ve okunaklı 3D strateji.',
  ...
  'online.confirmationTimeout': 'Oda doğrulaması zaman aşımına uğradı. Oynamadan önce yeniden bağlan.',
  ...
  'online.status.peer-waiting': 'rakip uzakta',
  'online.status.reconnecting': 'yeniden bağlanıyor',
  'online.status.waiting': 'bekliyor',
  'online.peerWaiting': 'Oda duraklatıldı - diğer oyuncunun dönmesi bekleniyor.',
  ...
  'options.coach': 'Koç',
  'options.feedback': 'Geri bildirim',
  'options.feedbackHint': 'Hata bildir, fikir paylaş',
  'options.sound': 'Ses',
  'options.style': 'Stil',
  ...
  'puzzle.cellLabel': 'Hücre {cell}, kat {floor}, satır {row}, sütun {column}, {value}',
  ...
  'setup.changingStarts': 'Bunları değiştirmek yeni maç başlatır',
  'setup.difficulty': 'AI',
  ...
  'setup.switchDifficultyConfirm': 'AI zorluğunu değiştirmek aktif best of 5 maçını sıfırlar.',
  'setup.switchModeConfirm': '{mode} moduna geçmek aktif best of 5 maçını sıfırlar.',
  'setup.switchRulesConfirm': '{ruleset} kuralına geçmek aktif best of 5 maçını sıfırlar.',
  'setup.switchSideConfirm': 'Taraf değiştirmek aktif best of 5 maçını sıfırlar.',
  'setup.title': 'Kurulum',
  'setup.youPlay': 'Sen oynarsın',
  'scanner.caption': 'Kat {floor} / 3',
  'scanner.firstUseHint': 'Kat {floor} / 3 — çizgiler katları aşabilir.',
  'sound.off': 'Kapalı',
  'sound.on': 'Açık',
  ...
  'status.confirmingOnlineAction': 'Odayla doğrulanıyor…',
  ...
  'status.opponentReconnect': 'Rakip bekleniyor',
...
const onlineMessageKeys: Record<string, I18nKey> = {
  ...
  'Room confirmation timed out. Reconnect before playing.':
    'online.confirmationTimeout',
